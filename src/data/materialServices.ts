...
register(["Цемент", "Бетон", "Пескобетон", "Добавки для бетона", "Опалубка и комплектующие"], {
...
register(["Ламинат", "Кварцвинил и SPC", "Подложка для пола"], {
  category: "Полы",
...
register(["Окна ПВХ", "Алюминиевые окна", "Стеклопакеты", "Подоконники и откосы"], {
...
register(["Двери входные", "Двери межкомнатные"], {
  category: "Окна и двери",
...
register(["Рольставни и гаражные ворота"], {
  category: "Окна и двери",
  subcategory: "Установка гаражных ворот",
  section: "services",
  imageCategoryId: "windows",
  actionTitle: "Найти монтажника ворот",
});

register(["Полипропиленовые трубы", "ПНД-трубы", "Металлопластиковые трубы", "Фитинги", "Запорная арматура"], {
  category: "Сантехника",
...
register(["Канализационные трубы"], {
  category: "Сантехника",
...
register(["Воздуховоды", "Комплектующие для вентиляции"], {
  category: "Инженерные системы",
  subcategory: "Вентиляция",
  section: "services",
  imageCategoryId: "engineering",
  actionTitle: "Найти монтажника вентиляции",
});

register(["Дымоходы"], {
  category: "Инженерные системы",
  subcategory: "Монтаж дымохода",
  section: "services",
  imageCategoryId: "engineering",
  actionTitle: "Найти монтажника дымохода",
});
...
register(["Электрощиты", "Автоматы и УЗО"], {
  category: "Электрика",
...
register(["Розетки и выключатели"], {
  category: "Электрика",
...
register(["Геотекстиль", "Георешётка", "Дренажные системы", "Дренажные трубы", "Дождеприёмники"], {
  category: "Участок и благоустройство",
...
export const MATERIAL_SPECIALIST_SUBCATEGORIES = MATERIAL_SUBCATEGORIES.filter((material) =>
  materialNames.has(normalize(material))
);
